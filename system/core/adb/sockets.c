...
{
//调试
fprintf(stdout,"smart_socket_enqueue,p->data:%s\n",(char*)p->data);
...
//调试
fprintf(stdout,"smart_socket_enqueue,service[1]:%s\n",service);
...
//调试
fprintf(stdout,"smart_socket_enqueue,service[2]:%s\n",service);
...
//调试
fprintf(stdout,"smart_socket_enqueue,service[3]:%s\n",service);
...
//调试
fprintf(stdout,"smart_socket_enqueue,service[4]:%s\n",service);
...
//调试
fprintf(stdout,"smart_socket_enqueue,service[5]:%s\n",service);
...
//调试
fprintf(stdout,"smart_socket_enqueue,service[6]:%s\n",service);
...
//调试
fprintf(stdout,"smart_socket_enqueue,service[7]:%s\n",service);
